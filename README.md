...
- **ヨガファイヤー（Ver.8）**: ダルシムの**伸縮する炎**（`↓` を溜めて `C` を押しながら**前**）。弾は飛ばさず、口から伸びて引っ込むまでの炎そのものが当たり判定です。伸びきったところで**343px**（キック95pxの3.6倍）に届きますが、その距離が出るのは6フレームだけ。全体60Fと長いので、外すと手痛く反撃されます
