...
- **選択画面のステータスゲージ（Ver.10）**: キャラを選んでいる間、カーソルが乗っているキャラの**威力・リーチ・発生**がゲージで見えます。ザンギエフは威力最大でリーチ最小、ダルシムはその逆、といったキャラ差が選ぶ前に分かります
...
| 画面 | パネルの中身 |
| --- | --- |
| キャラ選択 / CPU選択 / ステージ選択 | カーソルが乗っているキャラの**ステータスゲージ**（威力・リーチ・発生）と技のコマンド |
...
- [x] **Ver.10**: キャラ選択画面のステータスゲージ（威力・リーチ・発生）
